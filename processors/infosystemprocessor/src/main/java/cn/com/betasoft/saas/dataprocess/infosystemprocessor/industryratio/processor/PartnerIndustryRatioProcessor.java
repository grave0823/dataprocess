...
@Component
public class PartnerIndustryRatioProcessor implements ItemProcessor<IndustryRatioModel, IndustryRatioModel> {

    private static final Logger log = LoggerFactory.getLogger(PartnerIndustryRatioProcessor.class);
    ...
    public IndustryRatioModel process(IndustryRatioModel industryRatioModel) throws Exception {
        ...
        industryRatioModel.setType(IndustryRatioModel.TYPE_PARTNER);
