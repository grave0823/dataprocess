...
@Component
public class RegisterAreaRatioProcessor implements ItemProcessor<AreaRatioModel, AreaRatioModel> {

    private static final Logger log = LoggerFactory.getLogger(RegisterAreaRatioProcessor.class);
    ...
    public AreaRatioModel process(AreaRatioModel provinceRatioModel) throws Exception {
        ...
        provinceRatioModel.setType(AreaRatioModel.TYPE_REGISTER);
